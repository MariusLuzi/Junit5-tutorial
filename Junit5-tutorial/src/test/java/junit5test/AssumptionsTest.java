...
public class AssumptionsTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"steve,rogers", "captain,marvel", "bucky,barnes"})
    void csvSource_String(String Name, String Surname) {
        assumeFalse(Name.equals("steve"), "The assumption failed for the " +
                "following Surname: " + Surname);
